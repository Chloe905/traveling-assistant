export const messages = {
  en: {
    ...
    auth: {
      ...
      signInTitle: 'Sign in',
      signInHint: 'Use the email and password registered in Supabase Auth.',
      email: 'Email',
      password: 'Password',
  ...
  'zh-TW': {
    ...
    auth: {
      ...
      signInTitle: '登入',
      signInHint: '請使用 Supabase Auth 已註冊的 email 與密碼。',
      email: 'Email',
      password: 'Password',
      signingIn: '登入中...',
      signIn: '登入',
  ...
  ja: {
    ...
    auth: {
      ...
      signInTitle: 'ログイン',
      signInHint: 'Supabase Auth に登録済みのメールアドレスとパスワードを入力してください。',
      email: 'メール',
      password: 'パスワード',
      signingIn: 'ログイン中...',
      signIn: 'ログイン',
